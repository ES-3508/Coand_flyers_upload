...
# Read the CSV file
df = pd.read_csv('flyer_shop_ids.csv')
...
def create_catalog_page(catalog_id, shop_id, page_no, image_path):
    with open(image_path, 'rb') as image_file:
        ...
        headers = {
            "Authorization": "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..Z0GCUfc3tF7ouqno9QFGmHOLi6qYcH6c4CqwDxh1cL4"
        }
